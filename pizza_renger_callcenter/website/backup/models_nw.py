...
class Call(models.Model):
    ...
    customer_call_time = models.TimeField()
    member_register = models.ForeignKey('Member', models.DO_NOTHING, blank=True, null=True)
...
class Issue(models.Model):
    ...
    issuer = models.ForeignKey('Staff', models.DO_NOTHING, db_column='issuer')
...
class Order(models.Model):
    ...
    date = models.DateField()
    delivering_time = models.TimeField(blank=True, null=True)
...
class Shift(models.Model):
    ...
    date = models.DateField()
    check_in_shift_time = models.TimeField()
    check_out_shift_time = models.TimeField(blank=True, null=True)
